...
EOF
    ...
    docker compose run python-dev sh -c "python -m py_compile hello.py"
    docker compose run python-dev sh -c "python __pycache__/hello.cpython-313.pyc"
    docker compose run python-dev sh -c "printenv"
